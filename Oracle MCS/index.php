...
<head>
    ...
    <title> medical chaneling System </title>
    ...
    <!-- ################# Header Starts Here#######################--->
      ...
      <header id="menu-jk">
        ...
        <div id="nav-head" class="header-nav">
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-md-3  col-sm-12" style="color:#000;font-weight:bold; font-size:42px; margin-top: 1% !important;">ORACLE MCS
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item ">
                    <img class="d-block w-100" src="assets/images/slider/cr7.jpg" alt="Second slide">
                    <div class="carousel-cover"></div>
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <h5 class="animated bounceInDown">medical chaneling System</h5>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-key">
                        ...
                        <h5>quality medical treatment</h5>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12 map-img">
                    <h2>Contact Us</h2>
                    <address class="md-margin-bottom-40">isadin 34 nupe matara
